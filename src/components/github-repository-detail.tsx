      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-7 flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex shrink-0 flex-col gap-2">
            <Link href={`/chat/github/${encodeURIComponent(repository.owner)}/${encodeURIComponent(repository.name)}?autostart=1`} className="rounded-xl bg-sky-500 px-5 py-3 text-center text-sm font-medium text-black hover:bg-sky-400">Build with coding agent</Link>
