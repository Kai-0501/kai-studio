...
export const modelRoleDescriptions: readonly ModelRoleDescription[] = [
  ...
  { key: "vision", label: "Vision reviewer", description: "Reviews generated images against the approved visual brief before Kai Studio returns them.", capabilities: ["vision", "structured output"] },
  { key: "imagePlanner", label: "Image planner", description: "Turns an image request into a bounded, structured visual brief before generation.", capabilities: ["chat", "structured output"] },
  { key: "image", label: "Image generator", description: "Creates images only through Kai Studio's bounded generation pipeline.", capabilities: ["image generation"] },
