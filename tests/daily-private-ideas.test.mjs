...
test("Gemini structured output receives the compatible response schema", () => {
  ...
  try {
    const request = providerRequest("Return one object", { type: "object", minProperties: 1, properties: { name: { type: "string" }, ideas: { type: "array", minItems: 1, maxItems: 1, items: { type: "object" } } } }, "gemini");
