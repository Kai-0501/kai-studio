...
KaiLore now has a pluggable local embedding boundary. The default provider is a
...
Coding jobs use the same bounded-memory principles without importing KaiLore's
